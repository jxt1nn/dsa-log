<h2><a href="https://leetcode.com/problems/fair-distribution-of-cookies/">1418. Fair Distribution of Cookies</a></h2><h3>Medium</h3><hr><p>You are given an integer array <code>cookies</code>, where <code>cookies[i]</code> denotes the number of cookies in the <code>i<sup>th</sup></code> bag. You are also given an integer <code>k</code> that denotes the number of children to distribute <strong>all</strong> the bags of cookies to. All the cookies in the same bag must go to the same child and cannot be split up.</p>
